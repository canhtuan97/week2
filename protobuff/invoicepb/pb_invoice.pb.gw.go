...
func request_Invoice_CreateInvoice_0(ctx context.Context, marshaler runtime.Marshaler, client InvoiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Invoice_CreateInvoice_0(ctx context.Context, marshaler runtime.Marshaler, server InvoiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateInvoiceRequest
	var metadata runtime.ServerMetadata
...
func RegisterInvoiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InvoiceServer) error {
	...
	mux.Handle("POST", pattern_Invoice_CreateInvoice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Invoice_CreateInvoice_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Invoice_CreateInvoice_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterInvoiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InvoiceClient) error {
	...
	mux.Handle("POST", pattern_Invoice_CreateInvoice_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Invoice_CreateInvoice_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Invoice_CreateInvoice_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"rest", "V1", "order", "orderId", "invoice"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Invoice_CreateInvoice_0 = runtime.ForwardResponseMessage
)
